...
export default function WeatherWidget(){
    ...
    function getTemperatureMessage (temperature: number, unit : string):string{
        if(unit =="C"){
            if(temperature < 0){
                return `Brrr, it's freezing! at ${temperature}℃`
    ...
    function getWeatherData (description:string):string{
     switch(description.toLocaleLowerCase()){
        case "sunny":
            return "Sunny day! Enjoy the sunshine!";
        case "partly cloudy":
  ...
  <div className="flex justify-center items-center h-screen bg-purple-400">
    <Card className="w-full max-w-md mx-auto text-center bg-purple-700">
      <CardHeader>
        ...
        {weather && (
          <div className="mt-4 grid gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>{getWeatherData(weather.description)}</div>
            </div>
            <div className="flex items-center gap-2">
